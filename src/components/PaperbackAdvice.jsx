...
import { paperbackAdvice } from "./../data/paperbackAdvice";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) => endpoint.list_name_encoded === "paperback-advice"
).url;

const PaperbackAdvice = () => {
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && <h1 className="text-center">Advice Paperback</h1>}
...
export default PaperbackAdvice;
