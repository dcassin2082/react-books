...
import { hardcoverFiction } from "../data/hardcoverFiction";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) => endpoint.list_name_encoded === "hardcover-fiction"
).url;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && <h1 className="text-center">Hard Cover Fiction</h1>}
