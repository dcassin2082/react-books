...
import { combinedPrintAndEBookFiction } from "../data/combinedFiction";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) =>
    endpoint.list_name_encoded === "combined-print-and-e-book-fiction"
).url;
...
const EBookFiction1 = () => {
  ...
  const searchBooks = async (searchTerm) => {
    ...
    const data = combinedPrintAndEBookFiction;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && (
          <h1 className="text-center">Combined Print & E-Book Fiction</h1>
        )}
