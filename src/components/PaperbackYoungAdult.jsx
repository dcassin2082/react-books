...
import { youngAdultPaperback } from "../data/youngAdultPaperback";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) => endpoint.list_name_encoded === "young-adult-paperback"
).url;

const PaperbackYoungAdult = () => {
  ...
  const searchBooks = async (searchTerm) => {
    ...
    const data = youngAdultPaperback;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && <h1 className="text-center">Young Adult Paperback</h1>}
...
export default PaperbackYoungAdult;
