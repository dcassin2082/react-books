...
import { childrensMiddleGradeHardcover } from "./../data/childrensMiddleGradeHardcover";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) =>
    endpoint.list_name_encoded === "childrens-middle-grade-hardcover"
).url;

const HardCoverChildrensMiddleGrade = () => {
  ...
  const searchBooks = async (searchTerm) => {
    ...
    const data = childrensMiddleGradeHardcover;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && (
          <h1 className="text-center">Children's Middle Grade Hard Cover</h1>
        )}
...
export default HardCoverChildrensMiddleGrade;
