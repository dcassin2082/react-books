...
import { ebookNonfiction } from "../data/ebookNonfiction";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) =>
    endpoint.list_name_encoded === "combined-print-and-e-book-nonfiction"
).url;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && (
          <h1 className="text-center">Combined Print & E-Book Non-Fiction</h1>
        )}
