...
import { miscellaneousAdvice } from "../data/miscellaneousAdvice";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) => endpoint.list_name_encoded === "advice-how-to-and-miscellaneous"
).url;
...
const MiscellaneousAdvice = () => {
  ...
  const searchBooks = async (searchTerm) => {
    ...
    const data = miscellaneousAdvice;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && (
          <h1 className="text-center">Advice, How-To & Miscellaneous</h1>
        )}
...
export default MiscellaneousAdvice;
