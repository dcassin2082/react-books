...
import { childrensMiddleGradePaperback } from "../data/childrensMiddleGradePaperback";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) =>
    endpoint.list_name_encoded === "childrens-middle-grade-paperback"
).url;

const PaperbackChildrensMiddleGrade = () => {
  ...
  const searchBooks = async (searchTerm) => {
    ...
    const data = childrensMiddleGradePaperback;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && (
          <h1 className="text-center">Children's Middle Grade Paperback</h1>
        )}
...
export default PaperbackChildrensMiddleGrade;
