...
import { youngAdultHardcover } from "../data/youngAdultHardcover";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) => endpoint.list_name_encoded === "young-adult-hardcover"
).url;

const HardCoverYoungAdult = () => {
  ...
  const searchBooks = async (searchTerm) => {
    ...
    const data = youngAdultHardcover;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && <h1 className="text-center">Young Adult Hard Cover</h1>}
...
export default HardCoverYoungAdult;
