...
import { hardcoverAdvice } from "../data/hardcoverAdvice";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) => endpoint.list_name_encoded === "hardcover-advice"
).url;

const HardCoverAdvice = () => {
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && <h1 className="text-center">Hard Cover Advice</h1>}
...
export default HardCoverAdvice;
