...
import { massMarketPaperback } from "../data/massMarketPaperback";
...
const booksEndpoint = nyTimesLists.find(
  (endpoint) => endpoint.list_name_encoded === "mass-market-paperback"
).url;

const PaperbackMassMarket = () => {
  ...
  const searchBooks = async (searchTerm) => {
    ...
    const data = massMarketPaperback;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && <h1 className="text-center">Mass Market Paperback</h1>}
...
export default PaperbackMassMarket;
