...
import { tradeFictionPaperback } from "./../data/tradeFictionPaperback";
...
const PaperbackTradeFiction = () => {
  ...
  const searchBooks = async (searchTerm) => {
    ...
    const data = tradeFictionPaperback;
  ...
  return (
    <>
      ...
      <main className="items-center justify-center">
        {!loading && <h1 className="text-center">Trade Fiction Paperback</h1>}
        {!searchTerm && (
          <>
...
export default PaperbackTradeFiction;
